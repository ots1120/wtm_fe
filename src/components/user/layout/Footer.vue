  ...
  <footer class="fixed bottom-0 w-full">
    <div class="flex justify-evenly bg-slate-200">
          ...
          <span class="rounded-2xl border-2 border-solid bg-white p-2 block">
            <svg class="w-10" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <g id="SVGRepo_iconCarrier">
                ...
                <path d="M19.8786 18.3487L25.6829 24.153C26.1057 24.5758 26.1057 25.2613 25.6829 25.6841C25.2601 26.1069 24.5746 26.1069 24.1518 25.6841L18.3475 19.8798L19.8786 18.3487Z" fill="#000000"></path>
              </g>
            </svg>
          </span>
          <span>검색</span>
      ...
      <div>
        <button>
          <span class="rounded-2xl border-2 border-solid bg-white p-2 block">
            <svg class="w-10" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" stroke-width="3" stroke="#000000" fill="none">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
