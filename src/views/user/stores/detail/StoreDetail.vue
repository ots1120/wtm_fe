  ...
  <div>
    ...
    <StoreDetailTabs :tabs="['홈', '메뉴', '식권', '리뷰', '공지']">
      ...
      <template #tab3>
        ...
        <div>
          <StoreDetailReviewList class="p-4"
      ...
      <template #tab4>
        <div>
          <StoreDetailNoticeList class="p-4"
            v-for="(noticeData, index) in noticeDatas"
            :key="index"
            :storeName="noticeData.storeName"
            :daysAgo="noticeData.daysAgo"
  ...
  data() {
    return {
      ...
      noticeDatas: [{
          ...
          noticeContent: '여름휴가일정으로 15~17일 휴무입니다! 여름 휴가로 15일~17일(목~토)임시 휴일입니다. 감사합니다!' // Example remaining tickets
          },
          {
          storeName: '인쌩맥주', // Example month
          daysAgo: '2', // Example purchase amount
