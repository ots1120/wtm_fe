...
// user
  ...
  { path: '/stores/store_id/reviews/{review_id}/report/new', component: NewReviewReport},
...
// Admin
  ...
  { path: '/admin/notice/edit/:noticeId', name: 'noticeEdit', component: AdminNoticeEdit, props: true} // 경로 수정
